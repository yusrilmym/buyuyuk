...
class DiagnosticsPaymentMethodScreen extends StatefulWidget {
  const DiagnosticsPaymentMethodScreen({Key? key}) : super(key: key);

  @override
  State<DiagnosticsPaymentMethodScreen> createState() =>
      _DiagnosticsPaymentMethodScreenState();
}

class _DiagnosticsPaymentMethodScreenState
    extends State<DiagnosticsPaymentMethodScreen> {
